...
print("Category: ",u[3]); userlist[0]['type_2'] = 'Chicken'
...
## DUMP DATA SAMPLE ##
with open('dictionary_sample.pickle', 'wb') as handle:
    pickle.dump(l[:10], handle)
...
#
# os.system("mongoexport --db rdata --collection restaurants --type=csv --fields name,street,city,city_group,state,zip,latitude,longitude,type,type_2,avg_rating --out new_output.csv")
#
...
# print(db.collection_names())
#
# os.system("mongoexport --db rdata --collection aggregate_restaurants --type=csv --fields name,street,city,city_group,state,zip,latitude,longitude,cuisinetype,cuisinetype_2,avg_rating,item,price,description --out new_output_allmenuitems.csv")
...
#
# with open('new_output_allmenuitems.csv','r') as fin:
